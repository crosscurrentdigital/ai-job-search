...
- **Marketing / growth / social media:** Self-identified as a weaker area, with concrete traction numbers backing it up: CrossCurrent Digital has ~60 subscribers after five years of operation, and WatchSafe.app has not yet gained meaningful traction despite being live. Never state these numbers in a CV or cover letter, and never volunteer them unprompted in an interview - but if directly asked about personal growth/revenue track record (realistic for GTM-adjacent or revenue-org roles), answer honestly rather than deflect. Frame per the prepared "biggest weakness" answer below: this gap is precisely why BizPilotAI.app exists, and the same instinct (systematize what you're personally weaker at rather than avoid it) applies to enablement-style roles. Across his ventures, a strong product and a deep upfront development investment (e.g. ~$500k into CrossCurrent Digital's traditional development build) have not translated into scale, because the marketing/growth-and-distribution engine was underbuilt relative to the product. Rather than just outsourcing the gap, he is actively building an AI-first solution to it: BizPilotAI.app is a second-brain, agentic content-generation and social-media-management platform built specifically to close this weakness with AI tooling. Frame positively as: recognized the gap, then built and used his own AI-assisted tooling to address it directly - a concrete, provable example of applying AI transformation to his own weakest function, not just to client-facing problems
